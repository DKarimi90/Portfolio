    ...
    <div className={`w-full h-20 md:h-24 z-10 fixed ${scroll? 'shadow-md bg-[#f8f9fa] dark:bg-black' : ''}`}>
        <div className='w-full h-full max-w-[1000px] mx-auto flex justify-between px-4 items-center '>
            ...
            <div className='hidden md:flex'>
                ...
                <Link to="about" className='links' smooth={true} duration="700" activeClass='active-link' spy={true}>About</Link>
        ...
        {/* Mobile menu  */}
            ...
            <div className={`flex flex-col absolute left-0 top-0 px-4 py-11 w-full h-screen bg-[var(--secondary2)] transform-translate duration-700 ease-in-out dark:bg-[#000] ${!nav? '-translate-y-full' : 'translate-y-0'}`}>
                <h1 className='text-4xl font-bold mb-2 dark:text-[var(--primary2)] hover:text-[var(--primary1)] cursor-pointer dark:hover:text-[var(--secondary2)]'><Link onClick={toggleNav} to="home" smooth={true} duration="700">David</Link></h1>
                <Link onClick={toggleNav} to="home" className='mob-links' smooth={true} duration="700" activeClass='active-link' spy={true}>Home</Link>
                <Link onClick={toggleNav} to="about" className='mob-links' smooth={true} duration="700" activeClass='active-link' spy={true}>About</Link>
                <Link onClick={toggleNav} to="skills" className='mob-links' smooth={true} duration="700" activeClass='active-link' spy={true}>Skills</Link>
                <Link onClick={toggleNav} to="projects" className='mob-links' smooth={true} duration="700" activeClass='active-link' spy={true}>Projects</Link>
        ...
        {/* Social media icons */}
                    <a href="https://www.linkedin.com/in/karimi-m-345a79259/" target="_blank"><BsLinkedin className='icon-mob'/></a>
